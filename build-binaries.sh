...
echo "  docker build -f docker/Dockerfile.server -t ar-13-server ."
echo "  docker build -f docker/Dockerfile.worker -t ar-13-worker ."
echo "  Or use: docker-compose -f docker/docker-compose.yml build"
